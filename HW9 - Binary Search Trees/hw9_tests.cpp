...
CPSC 223-01
HW9
This hw9_tests.cpp file tests functions 
...
// Test 10 - Leaf/Left Child case
TEST(BasicCollectionTest, Leaf) {
  BSTCollection<string, double> c;
  c.insert("b", 10.0);
  c.insert("a", 20.0);
  c.insert("c", 30.0);
...
// Test 12 - 2 child case 
TEST(BasicCollectionTest, TwoChildren) { 
  BSTCollection<string, double> c;
  c.insert("e", 10.0);
  c.insert("c", 20.0);
  c.insert("d", 30.0);
